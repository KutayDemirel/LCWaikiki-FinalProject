...
namespace MiniCommerce.Persistence.DbContexts
{
    ...
    public class MiniCommerceDbContext : IdentityDbContext<User, Role, int>
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            var user6 = new User() { Id = 6, FirstName = "Kaan", LastName = "Kara", Address = "İzmir", Email = "kaan@seeddata.com", EmailConfirmed = true, NormalizedEmail = "KAAN@SEEDDATA.COM", UserName = "kaan@seeddata.com", NormalizedUserName = "KAAN@SEEDDATA.COM", PasswordHash = hasher.HashPassword(null, "kan.123456*"), SecurityStamp = Guid.NewGuid().ToString("D") };
            ...
            modelBuilder.Entity<Category>().HasData(
                        new Category { Id = 1, Name = "Mont", Description = "Soğuk kış günleri üşümeyin diye", CreatedDate = new DateTime(2022, 04, 16) },
                        new Category { Id = 2, Name = "Hırka ve Süveter", Description = "Soğuk kış günleri üşümeyin diye", CreatedDate = new DateTime(2022, 04, 16) },
                        new Category { Id = 3, Name = "Kazak", Description = "Soğuk kış günleri üşümeyin diye", CreatedDate = new DateTime(2022, 04, 16) },
                        new Category { Id = 4, Name = "Gömlek", Description = "Keten Rahatlığı", CreatedDate = new DateTime(2022, 04, 16) },
                        new Category { Id = 5, Name = "Tişört", Description = "Güneşin keyfini çıkar", CreatedDate = new DateTime(2022, 04, 16) },
                        new Category { Id = 6, Name = "Sweatshirt", Description = "Favorilerini seç, en trend ürünleri keşfet", CreatedDate = new DateTime(2022, 04, 16) },
                        new Category { Id = 7, Name = "Jean", Description = "Sezonun en hit parçalarını keşfet", CreatedDate = new DateTime(2022, 04, 16) },
                        new Category { Id = 8, Name = "Elbise", Description = "demodemodemo", CreatedDate = new DateTime(2022, 04, 16) }
            );


            modelBuilder.Entity<Product>().HasData(
                        new Product { Id = 1, CategoryId = 1, ColorId = 7, UserId = 1, UsageId = 1, BrandId = 4, ImageUrl = "LCWCASUALBejMont.jpg", Name = "Slim Fit Kapüşonlu İnce Erkek Kanguru Mont", Description = "Soğuk kış günleri üşümeyin diye", Stock = 400, Price = 309.99m, IsOfferable = true, IsSold = false, CreatedDate = new DateTime(2022, 04, 16) },
                        new Product { Id = 2, CategoryId = 1, ColorId = 5, UserId = 1, UsageId = 2, BrandId = 4, ImageUrl = "LCWCASUALPembeMont.jpg", Name = "Dik Yaka Düz Uzun Kollu İnce Kadın Mont", Description = "Soğuk kış günleri üşümeyin diye", Stock = 400, Price = 319.99m, IsOfferable = true, IsSold = false, CreatedDate = new DateTime(2022, 04, 16) },
                        new Product { Id = 3, CategoryId = 2, ColorId = 4, UserId = 1, UsageId = 3, BrandId = 5, ImageUrl = "LCWBASICBeyazHirka.jpg", Name = "Bisiklet Yaka Düz Uzun Kollu Viskon Kadın Hırka", Description = "Soğuk kış günleri üşümeyin diye", Stock = 400, Price = 59.99m, IsOfferable = true, IsSold = false, CreatedDate = new DateTime(2022, 04, 16) },
                        new Product { Id = 4, CategoryId = 2, ColorId = 6, UserId = 1, UsageId = 1, BrandId = 2, ImageUrl = "XSIDEYeşilHırka.jpg", Name = "Dik Yaka Düz Uzun Kollu Crop Kadın Hırka", Description = "Soğuk kış günleri üşümeyin diye", Stock = 400, Price = 109.99m, IsOfferable = true, IsSold = false, CreatedDate = new DateTime(2022, 04, 16) },
                        new Product { Id = 5, CategoryId = 3, ColorId = 2, UserId = 2, UsageId = 2, BrandId = 1, ImageUrl = "LCWVISIONSarıKazak.jpg", Name = "Bisiklet Yaka Uzun Kollu Erkek Triko Kazak", Description = "Soğuk kış günleri üşümeyin diye", Stock = 400, Price = 139.99m, IsOfferable = true, IsSold = false, CreatedDate = new DateTime(2022, 04, 16) },
                        new Product { Id = 6, CategoryId = 3, ColorId = 3, UserId = 2, UsageId = 1, BrandId = 4, ImageUrl = "LCWCASUALKirmiziKazak.jpg", Name = "Bisiklet Yaka Düz Uzun Kollu Kadın Triko Kazak", Description = "Soğuk kış günleri üşümeyin diye", Stock = 400, Price = 99.99m, IsOfferable = true, IsSold = false, CreatedDate = new DateTime(2022, 04, 16) },
                        new Product { Id = 7, CategoryId = 4, ColorId = 8, UserId = 3, UsageId = 1, BrandId = 6, ImageUrl = "LCWFORMALMaviGomlek.jpg", Name = "Slim Fit Uzun Kollu Poplin Erkek Gömlek", Description = "Soğuk kış günleri üşümeyin diye", Stock = 400, Price = 289.99m, IsOfferable = true, IsSold = false, CreatedDate = new DateTime(2022, 04, 16) },
                        new Product { Id = 8, CategoryId = 4, ColorId = 4, UserId = 3, UsageId = 2, BrandId = 1, ImageUrl = "LCWVISIONBeyazGomlek.jpg", Name = "Önden Düğme Kapamalı Düz Kısa Kollu Poplin Kadın Gömlek", Description = "Soğuk kış günleri üşümeyin diye", Stock = 400, Price = 149.99m, IsOfferable = true, IsSold = false, CreatedDate = new DateTime(2022, 04, 16) },
                        new Product { Id = 9, CategoryId = 5, ColorId = 2, UserId = 3, UsageId = 3, BrandId = 2, ImageUrl = "XSIDESarıTisort.jpg", Name = "Bisiklet Yaka Baskılı Kısa Kollu Pamuklu Crop Kadın Tişört", Description = "Soğuk kış günleri üşümeyin diye", Stock = 400, Price = 99.99m, IsOfferable = true, IsSold = false, CreatedDate = new DateTime(2022, 04, 16) },
                        new Product { Id = 10, CategoryId = 5, ColorId = 1, UserId = 4, UsageId = 1, BrandId = 4, ImageUrl = "LCWCASUALSiyahTisort.jpg", Name = "Polo Yaka Kısa Kollu Pike Erkek Tişört", Description = "Soğuk kış günleri üşümeyin diye", Stock = 400, Price = 149.99m, IsOfferable = true, IsSold = false, CreatedDate = new DateTime(2022, 04, 16) },
                        new Product { Id = 11, CategoryId = 6, ColorId = 8, UserId = 5, UsageId = 3, BrandId = 2, ImageUrl = "XSIDEMaviSweatShirt.jpg", Name = "Kapüşon Yaka Nakışlı Uzun Kollu Kadın Sweatshirt", Description = "Soğuk kış günleri üşümeyin diye", Stock = 400, Price = 89.99m, IsOfferable = true, IsSold = false, CreatedDate = new DateTime(2022, 04, 16) },
                        new Product { Id = 12, CategoryId = 6, ColorId = 6, UserId = 6, UsageId = 2, BrandId = 2, ImageUrl = "XSIDEYeşilSweatShirt.jpg", Name = "Kapüşonlu Uzun Kollu Baskılı Erkek Sweatshirt", Description = "Soğuk kış günleri üşümeyin diye", Stock = 400, Price = 199.99m, IsOfferable = true, IsSold = false, CreatedDate = new DateTime(2022, 04, 16) },
                        new Product { Id = 13, CategoryId = 7, ColorId = 9, UserId = 7, UsageId = 1, BrandId = 4, ImageUrl = "LCWCASULGriJean.jpg", Name = "750 Slim Fit Erkek Jean Pantolon", Description = "Soğuk kış günleri üşümeyin diye", Stock = 400, Price = 189.99m, IsOfferable = true, IsSold = false, CreatedDate = new DateTime(2022, 04, 16) },
                        new Product { Id = 14, CategoryId = 8, ColorId = 6, UserId = 8, UsageId = 2, BrandId = 1, ImageUrl = "LCWVISIONYesilElbise.jpg", Name = "Halter Yaka Düz Kolsuz Kadın Elbise", Description = "Soğuk kış günleri üşümeyin diye", Stock = 400, Price = 199.99m, IsOfferable = true, IsSold = false, CreatedDate = new DateTime(2022, 04, 16) },
                        new Product { Id = 15, CategoryId = 8, ColorId = 5, UserId = 2, UsageId = 1, BrandId = 3, ImageUrl = "LCWCASUALPembeElbise.jpg", Name = "U Yaka Düz Askılı A Kesim Poplin Kadın Elbise", Description = "Soğuk kış günleri üşümeyin diye", Stock = 400, Price = 199.99m, IsOfferable = true, IsSold = false, CreatedDate = new DateTime(2022, 04, 16) }
            );
            ...
            modelBuilder.Entity<Offer>().HasData(
                        ...
                        new Offer { Id = 18, Price = 95.00m, CreatedDate = new DateTime(2022, 04, 16), ProductId = 1, UserId = 3, IsApproved = false },
                        new Offer { Id = 19, Price = 56.00m, CreatedDate = new DateTime(2022, 04, 16), ProductId = 2, UserId = 3, IsApproved = false },
                        new Offer { Id = 20, Price = 76.00m, CreatedDate = new DateTime(2022, 04, 16), ProductId = 3, UserId = 4, IsApproved = false },
                        new Offer { Id = 21, Price = 63.00m, CreatedDate = new DateTime(2022, 04, 16), ProductId = 4, UserId = 4, IsApproved = false },
                        new Offer { Id = 22, Price = 95.00m, CreatedDate = new DateTime(2022, 04, 16), ProductId = 1, UserId = 3, IsApproved = false },
                        new Offer { Id = 23, Price = 56.00m, CreatedDate = new DateTime(2022, 04, 16), ProductId = 2, UserId = 3, IsApproved = false },
                        new Offer { Id = 24, Price = 76.00m, CreatedDate = new DateTime(2022, 04, 16), ProductId = 3, UserId = 4, IsApproved = false },
                        new Offer { Id = 25, Price = 63.00m, CreatedDate = new DateTime(2022, 04, 16), ProductId = 3, UserId = 4, IsApproved = false },
                        new Offer { Id = 26, Price = 95.00m, CreatedDate = new DateTime(2022, 04, 16), ProductId = 1, UserId = 3, IsApproved = false },
                        new Offer { Id = 27, Price = 56.00m, CreatedDate = new DateTime(2022, 04, 16), ProductId = 2, UserId = 3, IsApproved = false },
                        new Offer { Id = 28, Price = 76.00m, CreatedDate = new DateTime(2022, 04, 16), ProductId = 3, UserId = 4, IsApproved = false },
                        new Offer { Id = 29, Price = 63.00m, CreatedDate = new DateTime(2022, 04, 16), ProductId = 4, UserId = 4, IsApproved = false },
                        new Offer { Id = 30, Price = 95.00m, CreatedDate = new DateTime(2022, 04, 16), ProductId = 1, UserId = 3, IsApproved = false },
                        new Offer { Id = 31, Price = 56.00m, CreatedDate = new DateTime(2022, 04, 16), ProductId = 2, UserId = 3, IsApproved = false },
                        new Offer { Id = 32, Price = 76.00m, CreatedDate = new DateTime(2022, 04, 16), ProductId = 3, UserId = 4, IsApproved = false },
                        new Offer { Id = 33, Price = 63.00m, CreatedDate = new DateTime(2022, 04, 16), ProductId = 4, UserId = 4, IsApproved = false }
