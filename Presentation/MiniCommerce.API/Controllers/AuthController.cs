...
using MiniCommerce.Application.Features.Queries.Authentications.GetUser;
...
namespace Delivery.Api.Controllers
{
    ...
    public class AuthController : ControllerBase
    {
        ...
        public async Task<IActionResult> SignIn(string email, string password)
        {
            ...
            if (userModel != null)
            {
                userModel.Data.Token = GenerateJwt(userModel.Data);

                var response = new ServiceResponse<UserViewModel>(ResultTypeEnum.Success, "", userModel.Data);
        ...
        private string GenerateJwt(UserViewModel userModel)
        {
            ...
            //Başka uygulamayla konuşurken Security  Key'in alıyoruz.
            var key = new SymmetricSecurityKey(Encoding.UTF8.GetBytes(_jwtSettings.Secret));

            //Blockchain şifrelemesinde kullanılan şifreleme..
